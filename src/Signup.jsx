    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isSignUp) {
                ...
                // Since email confirmation might be disabled or enabled, handle both
                navigate('/');
            } else {
            ...
            <div className="relative z-10 w-full max-w-sm md:max-w-md mx-auto px-6 mt-16 md:mt-0">
                <div className="bg-background/5 backdrop-blur-xl border border-background/10 rounded-[2.5rem] p-6 md:p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <button type="submit" disabled={loading} className="w-full bg-white text-black hover:bg-gray-200 transition-colors rounded-full px-8 py-3 font-bold text-base mt-2 font-sans flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl">
